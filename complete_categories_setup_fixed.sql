-- =====================================================
-- SCRIPT TỔNG HỢP - THÊM SHOP VÀ SẢN PHẨM THEO LOẠI GIAN HÀNG (SỬA LỖI)
-- Chạy script này để thêm đầy đủ các shop và sản phẩm theo dropdown
-- Đã sửa lỗi duplicate ID
-- =====================================================

-- Chạy script thêm shop và sản phẩm (đã sửa lỗi ID)
SOURCE fix_duplicate_ids.sql;

-- Chạy script thêm warehouse items (đã sửa lỗi ID)
SOURCE fix_warehouse_items.sql;
...
-- =====================================================
-- HOÀN THÀNH SETUP THEO LOẠI GIAN HÀNG (ĐÃ SỬA LỖI)
-- =====================================================
