...
public class WithdrawService {
    ...
    public void approveWithdrawRequest(Long requestId) {
        ...
        log.info("Approved withdraw request: {} for amount: {}", requestId, request.getAmount());
    }
    ...
    public void rejectWithdrawRequest(Long requestId) {
        ...
        log.info("Rejected withdraw request: {} and returned amount: {} to wallet", requestId, request.getAmount());
    }
}
